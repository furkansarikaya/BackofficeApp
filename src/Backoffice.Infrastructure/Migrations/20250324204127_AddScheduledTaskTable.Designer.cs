...
namespace Backoffice.Infrastructure.Migrations
{
    ...
    [Migration("20250324204127_AddScheduledTaskTable")]
    partial class AddScheduledTaskTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backoffice.Domain.Entities.ScheduledTasks.ScheduledTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Backoffice.Domain.Entities.ScheduledTasks.TaskExecutionHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_task_execution_history");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_task_execution_history_task_id");
            ...
            modelBuilder.Entity("Backoffice.Domain.Entities.ScheduledTasks.TaskExecutionHistory", b =>
                {
                    b.HasOne("Backoffice.Domain.Entities.ScheduledTasks.ScheduledTask", "Task")
                        .WithMany()
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_execution_history_scheduled_task_task_id");
